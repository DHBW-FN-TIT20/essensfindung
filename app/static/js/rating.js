...
function sortDOMTime(list, direction, parent) {
...
function sortDOMRating(list, direction, parent) {
...
function init() {
    ...
    document.getElementById("sortDateDesc").addEventListener("click", e => {
        ...
        if (e.target.checked) {
            ...
            sortDOMTime(entries, false, parent);
        }
    });
    ...
    document.getElementById("sortDateAsc").addEventListener("click", e => {
        ...
        if (e.target.checked) {
            ...
            //bubble sort to rearrange dom
            sortDOMTime(entries, true, parent);
        }
    });
    ...
    document.getElementById("sortRatingDesc").addEventListener("click", e => {
        ...
        if (e.target.checked) {
            ...
            //bubble sort to rearrange dom
            sortDOMRating(entries, false, parent);
        }
    });
    //sorts by rating asc
    document.getElementById("sortRatingAsc").addEventListener("click", e => {
        ...
        if (e.target.checked) {
            ...
            //bubble sort to rearrange dom
            sortDOMRating(entries, true, parent);
        }
    });
